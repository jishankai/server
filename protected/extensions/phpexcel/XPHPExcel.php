...
class XPHPExcel extends CComponent
{
	...
	public static function init()
	{
		if (!self::$_isInitialized) {
			...
			require(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'PHPExcel' . DIRECTORY_SEPARATOR . 'IOFactory.php');
    ...
    public static function readPHPExcel($filePath)
    {
        self::init();
